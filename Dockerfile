...
ENV TZ=Asia/Tokyo
ENV PATH /usr/local/texlive/2020/bin/x86_64-linux:/usr/local/texlive/2020/bin/aarch64-linux:$PATH
ENV LANG=C.UTF-8
...
ARG INSTALL_TL_URL="https://ftp.math.utah.edu/pub/tex/historic/systems/texlive/2020/tlnet-final/install-tl-unx.tar.gz"
ARG INSTALL_TL_REPOSITORY="https://ftp.math.utah.edu/pub/tex/historic/systems/texlive/2020/tlnet-final/"
